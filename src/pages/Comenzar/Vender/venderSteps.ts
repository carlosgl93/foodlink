...
export const venderSteps = [
  {
    title: 'Productos ofrecidos',
    text: '¿Qué tipo de productos ofrece tu empresa?',
    options: [
      {
        id: '0',
  ...
  },
  {
    ...
    text: '¿Tus productos cumplen con alguna certificación?',
    options: [
      {
        id: '10',
        value: 'libre-sellos',
  ...
  // },
  {
    title: 'Comunas de despacho',
    text: '¿A qué comunas llegas con tus productos?',
  },
];
