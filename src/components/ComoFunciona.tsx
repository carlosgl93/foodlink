...
const comoFuncionaCardsContent = [
  {
    image: `${import.meta.env.VITE_PUBLIC_URL}/blui-icon-1.png`,
  ...
  {
    image: `${import.meta.env.VITE_PUBLIC_URL}/blui-icon-2.png`,
  ...
  {
    image: `${import.meta.env.VITE_PUBLIC_URL}/blui-icon-3.png`,
